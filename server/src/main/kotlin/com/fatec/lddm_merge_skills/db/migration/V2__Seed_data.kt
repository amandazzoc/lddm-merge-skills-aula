...
/**
 * ╔══════════════════════════════════════════════════════════════════╗
 * ║  V3__Seed_Data — Populando o Banco com Dados Iniciais           ║
 * ╚══════════════════════════════════════════════════════════════════╝
 *
 * 🔑 CONCEITO: Seed (Semente de Dados)
 * ─────────────────────────────────────
 * Um "seed" é um conjunto de dados iniciais inseridos no banco
 * para que o sistema já tenha conteúdo ao ser iniciado.
 *
 * Usamos uma migração Flyway (V3) para garantir que o seed
 * rode APENAS UMA VEZ e na ordem correta (depois do schema).
 *
 * 📋 DADOS INSERIDOS:
 *   - 4 cursos (Java, Kotlin, Python, TypeScript)
 *   - 16 lições (4 por curso)
 *   - 120 questões (5 por lição, com código e alternativas)
 */
